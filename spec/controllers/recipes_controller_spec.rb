...
RSpec.describe RecipesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns user's recipes to @recipes" do
      ...
      recipe1 = Recipe.create(name: 'Recipe 1', description: 'Delicious recipe', preparation_time: 20, cooking_time: 10, user: user)
      recipe2 = Recipe.create(name: 'Recipe 2', description: 'Another great recipe', preparation_time: 30, cooking_time: 10, user: user)
  ...
  describe "DELETE #destroy" do
    it "destroys the recipe" do
      ...
      recipe_to_delete = Recipe.create(name: 'Recipe to Delete', description: 'A recipe to be deleted', preparation_time: 20, cooking_time: 10, user: user)
  ...
  describe "POST #create" do
    it "creates a new recipe" do
      ...
      post :create, params: { recipe: { name: 'New Recipe', description: 'A new recipe', preparation_time: '30', cooking_time: '45', public: true } }
  ...
  describe "GET #show" do
    it "renders the recipe's show page" do
      ...
      user = User.create(name: 'John', email: 'john@example.com', password: 'password')
      recipe = Recipe.create(name: 'Test Recipe', description: 'A delicious test recipe', preparation_time: 30, cooking_time: 45, user: user)
  ...
  describe "PATCH #toggle_visibility" do
    it "toggles the recipe's public visibility" do
      # Create a user and a recipe for testing
      user = User.create(name: 'John', email: 'john@example.com', password: 'password')
      recipe = Recipe.create(name: 'Test Recipe', description: 'A delicious test recipe', preparation_time: 30, cooking_time: 45, user: user, public: false)

...
ingredient_one = user_one.ingredients.create!(name: 'pepper', measurement_unit: 'g', price: 1, quantity: 1)
ingredient_two = user_two.ingredients.create!(name: 'salt', measurement_unit: 'g', price: 1, quantity: 1)
...
ingredient_five = recipe_two.ingredients.create!(name: 'Chicken Breast', measurement_unit: 'Lb', price: 2, quantity: 2)

# Create additional ingredients and recipes
ingredient_three = user_two.ingredients.create!(name: 'corn', measurement_unit: 'g', price: 2, quantity: 2)
ingredient_four = user_one.ingredients.create!(name: 'apple', measurement_unit: 'pieces', price: 0.5, quantity: 3)
...
recipe_three = user_one.recipes.create!(
  ...
  Turpis massa tincidunt dui ut ornare lectus sit amet est. Duis ut diam quam nulla porttitor massa. Nulla porttitor massa id neque.',
  preparation_time: 25,
  cooking_time: 10,
  public: false,
